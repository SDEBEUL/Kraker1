MODULE mBuffer
 ...
 PROC Buffer_UIT_PickPart(num nBuffernum, wobjdata WobjBufferx, robtarget Pbuffer)
   ...
   VAR num zPos := 0;
 lbl_nextpart:
   yPos := nYposPart(nBuffernum ,\Inbuff:=TRUE);
   ZPos := nZposPart(nBuffernum ,\Inbuff:=TRUE);
   !
...
PROC Buffer_1_Uit()
    ...
    !
    Buffer_UIT_PickPart 1, Wobj_Buffer_Onder_1, pBuffer_Onder_1;
    ! 
...
PROC Buffer_2_Uit()
    ...
    !
    Buffer_UIT_PickPart 2, Wobj_Buffer_Onder_2, pBuffer_Onder_2;
    ! 
...
PROC Buffer_3_Uit()
    ...
    !
    Buffer_UIT_PickPart 3, Wobj_Buffer_Onder_3, pBuffer_Onder_3;
    ! 
...
PROC Buffer_4_Uit()
    ...
    !
    Buffer_UIT_PickPart 4, Wobj_Buffer_Onder_4, pBuffer_Onder_4;
    ! 
...
PROC Buffer_5_Uit()
    ...
    !
    Buffer_UIT_PickPart 5, Wobj_Buffer_Onder_5, pBuffer_Onder_5;
    ! 
...
PROC Buffer_6_Uit()
    ...
    !
    Buffer_UIT_PickPart 6, Wobj_Buffer_Onder_6, pBuffer_Onder_6;
    ! 
...
!-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
 ...
 PROC Buffer_IN_PutPart(num nBuffernum, wobjdata WobjBufferx, robtarget Pbuffer)
   ...
   VAR num yPos := 0;
   VAR num zPos := 0;
   yPos := nYposPart(nBuffernum ,\Outbuff:=TRUE);
   ZPos := nZposPart(nBuffernum ,\Outbuff:=TRUE);
   !
    wobj_Active:=WobjBufferx;
    wobj_Active.oframe.trans:=[xPos,yPos,zPos];
    !
